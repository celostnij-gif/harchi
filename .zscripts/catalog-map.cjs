/**
 * Мапінги живого каталогу harchifood.com → локальні слаги/категорії.
 * ЗГЕНЕРОВАНО з .zscripts/sync-live-catalog.cjs (node temp/extract-catalog-map.cjs).
 * Не редагувати вручну — правки робити в sync-live-catalog.cjs і перегенерувати.
 */
const LIVE_CATS = [
...
module.exports = { LIVE_CATS, BULK, SLUG_BULK, WOO_TO_LOCAL, WOO_CATS, SLUG_IMAGE };
